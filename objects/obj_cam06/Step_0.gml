...
{
	sprite_index = spr_rightvent_light;
	htme_globalSet("light",1,buffer_bool);
	if !audio_is_playing(snd_light2)
	{
		audio_play_sound(snd_light2,10,true);
	}
	if htme_globalGet("tfreddy") = 15
	{
		image_index = (htme_globalGet("freddySpecial")) ? 2 : 1;
	}
	else if htme_globalGet("tbonnie") = 15
	{
		image_index = (htme_globalGet("bonnieSpecial")) ? 4 : 3;
	}
	else if htme_globalGet("tchica") = 15
	{
		image_index = 5;
	}
	else if htme_globalGet("mangle") = 15
	{
		image_index = 6;
	}
	else if htme_globalGet("wfreddy") = 15
	{
		image_index = (htme_globalGet("freddySpecial")) ? 8 : 7;
	}
	else if htme_globalGet("wbonnie") = 15
	{
		image_index = (htme_globalGet("bonnieSpecial")) ? 10 : 9;
	}
	else if htme_globalGet("wchica") = 15
	{
		image_index = 11;
	}
	else if htme_globalGet("wfoxy") = 15
	{
		image_index = 12;
	}
	else if htme_globalGet("springtrap") = 15
	{
		image_index = 13;
	}
	else if htme_globalGet("mimic") = 15
	{
